    ...
    themeConfig: {
      nav: [
        ...
        },
        {
          text: "社会总复习",
          items: [
            { text: "人文地理", link: "/总复习/人文地理/" },
            { text: "中国历史", link: "/总复习/中国历史/" },
            { text: "世界历史", link: "/总复习/世界历史/" },
            { text: "道德与法治", link: "/总复习/道德与法治/" },
            { text: "时政热点", link: "/总复习/时政热点/" },
            { text: "打印专用", link: "/总复习/" },
          ]
        }
      ],
...
function summary_rev() {
  return [

    {
      ...
      items: [
        {
          text: "第一部分 地理学习的工具与方法",
          link: "/总复习/人文地理/第一部分 地理学习的工具与方法/",
        },
        {
          text: "第二部分 中国疆域和行政区划",
          link: "/总复习/人文地理/第二部分 中国疆域和行政区划/",
        },
        {
          text: "第三部分 中国自然环境和人文环境的基本特征",
          link: "/总复习/人文地理/第三部分 中国自然环境和人文环境的基本特征/",
        },
        {
          text: "第四部分 共同面对人类面临的“PRED”问题",
          link: "/总复习/人文地理/第四部分 共同面对人类面临的“PRED”问题/",
        },
        {
          text: "第五部分 认识家乡——宁波（简称“甬”）",
          link: "/总复习/人文地理/第五部分 认识家乡——宁波（简称“甬”）/",
        }
      ]
    },
    {
    ...
    },
    {
      ...
      items: [
        {
          text: "模块一 聚焦二十大",
          link: "/总复习/时政热点/模块一 聚焦二十大/",
        },
        {
          text: "模块二 重点时政新闻（2022年10月——2023年4月）",
          link: "/总复习/时政热点/模块二 重点时政新闻（2022年10月——2023年4月）/",
        },
      ],
    },
  ];
